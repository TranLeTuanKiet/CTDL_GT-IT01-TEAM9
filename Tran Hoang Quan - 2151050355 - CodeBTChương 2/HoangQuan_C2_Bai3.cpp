...
int main()
{
	...
	do {
		...
		case 4:
			...
			cin >> inf;
			Insert_first(inf);
			cout << "Them thanh cong, moi ban xem danh sach o che do 2.\n";
			break;
		case 5:
			Delete_first();
			cout << "Xoa thanh cong, moi ban xem danh sach o che do 2.\n";
			break;
		case 6:
		...
		case 8:
			...
			cin >> x;
			Search_Delte(x);
			cout << "Tim va xoa thanh cong, moi ban xem danh sach o che do 2.\n";
			break;
		case 9:
